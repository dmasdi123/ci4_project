                                    ...
                                    <div class="col">
                                        <form action="" method="POST">
                                            ...
                                            <div class="justify-content-center">
                                                <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#exampleModal" style="text-align: center;"> Tambahkan Mekanik <i class="fas fa-user-plus"></i></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
