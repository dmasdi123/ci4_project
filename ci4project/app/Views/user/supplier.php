                                        ...
                                        <?php foreach ($supplier as $supp) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url(); ?>/userController/deletesupp/<?= $supp['id_supp']; ?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class="far fa-trash-alt"></i></button></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
