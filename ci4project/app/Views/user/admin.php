                    ...
                    <?php foreach ($admin as $adm) : ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?= base_url(); ?>/UserController/deleteadm/<?= $adm['id_user']; ?>"><button name="iduser" type="button" class="btn btn-danger"><i class="far fa-trash-alt" onclick="return confirm('Apakah anda yakin menghapus data ini?')"></i></button></a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
