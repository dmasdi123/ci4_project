                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"> Form Edit Admin</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <form action="<?= base_url(); ?>/UserController/updateadmin/<?= $admin['id_user']; ?>" method="POST">
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Nama</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="nama_user" id="nama_user" value="<?= $admin['nama_user']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" class="form-control" name="notelp" id="notelp" value="<?= $admin['notelp']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
